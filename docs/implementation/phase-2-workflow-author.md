...
- [x] Project list screen — open, delete, create new
- [x] **Workflow Author** screen:
...
- [x] Project lands in `~/Documents/Trayline/projects/<project-name>/` with scaffolded workflow visible in the left rail
- [x] **Regenerate** flow:
  - User can edit description and regenerate
  - Previous version archived to `<project>/.history/<timestamp>/`
- [x] Post-scaffold banner:
...
- [x] Top bar project switcher
- [x] Settings → General (default AI adapter, theme)
