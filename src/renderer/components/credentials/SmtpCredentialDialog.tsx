  ...
  return (
    ...
    >
      <div className="space-y-4">
        <Field label="Name">
          <input className={inputCls} value={name} onChange={(e) => setName(e.target.value)} placeholder="Gmail SMTP" />
        </Field>
        <Field label="Host">
          <input className={`${inputCls} font-mono`} value={host} onChange={(e) => setHost(e.target.value)} placeholder="smtp.gmail.com" />
        </Field>
        ...
        <Field label="From address">
          <input className={inputCls} value={fromAddress} onChange={(e) => setFromAddress(e.target.value)} placeholder="user@gmail.com" />
        </Field>
      </div>
    </CredentialDialogShell>
  )
